...
// IAB is fully set up. Now, let's get an inventory of stuff we own.
    ...
    private void querySkuDetailsAsync(final String skuId ,final String billNo){
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                skuList.add(skuId);
                Log.d(TAG,"skuList" + skuList.toString());
    ...
    private void handlePurchase(final Purchase purchase ){
        ...
        try {
            final String billNo = purchase.getAccountIdentifiers().getObfuscatedAccountId();
            Log.d(TAG,"consumeAsync billNO = " + billNo);
                    ...
                    new ConsumeResponseListener() {
                        ...
                        public void onConsumeResponse(BillingResult billingResult, String purchaseToken) {
                            if (billingResult.getResponseCode() == BillingClient.BillingResponseCode.OK) {
                                ...
                                logBillResult("onConsumeResponse",billingResult, billNo);
                            }
                        }
                    });
        }catch (Exception e){
    ...
    private void logBillResult(String logtype,BillingResult billingResult,String billNo ){
        String msg = logtype + " 错误码code = " + billingResult.getResponseCode() + " ,  msg = " + billingResult.getDebugMessage();
