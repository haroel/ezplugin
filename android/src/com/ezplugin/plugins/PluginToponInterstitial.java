...
public class PluginToponInterstitial extends PluginBase {

    final public static String TAG = "PluginToponInterstitial";
    ...
    public void initPlugin(Context context, JSONObject jobj) {
        ...
        Boolean hasinited = PluginCore.getInstance().getPluginByName("PluginTopon")!= null;
        ...
        try{
            ...
            if (!hasinited){
                ...
                if (isDebug){
                    ...
                    Log.e(TAG,"调试模式下使用测试广告" +
                            " https://docs.toponad.com/#/zh-cn/android/android_doc/android_access_doc?id=_27-%e5%b9%bf%e5%91%8a%e6%b5%8b%e8%af%95%e8%af%b4%e6%98%8e ");
                }
        ...
        if (isDebug){
            placementID = "b5c21a303c25e0";
            Log.d(TAG,"使用Unity 插屏广告 placementID " + placementID);
        }
    ...
    private void createAndLoadRewardedAd(){
        ...
        Activity mActivity = (Activity) (getContext());
        final ATInterstitial mRewardVideoAd = new ATInterstitial(mActivity,this.placementID);
        final int rewardIDcount = RewardAdVOCount++;
        final PluginToponInterstitial plugin = this;
        mRewardVideoAd.setAdListener(new ATInterstitialListener() {
            @Override
            ...
            public void onInterstitialAdLoadFail(AdError errorCode) {
                Log.d(TAG,"onInterstitialAdLoadFail  "+errorCode.toString());
            ...
            public void onInterstitialAdVideoStart(ATAdInfo entity) {
                Log.d(TAG,"onInterstitialAdVideoStart  "+entity.toString());

            }

            @Override
            public void onInterstitialAdShow(ATAdInfo entity) {
                Log.d(TAG,"onInterstitialAdShow  "+entity.toString());
            ...
            public void onInterstitialAdVideoEnd(ATAdInfo entity) {
                Log.d(TAG,"onInterstitialAdVideoEnd  "+entity.toString());

            }

            @Override
            public void onInterstitialAdVideoError(AdError errorCode) {
                Log.e(TAG,"onInterstitialAdVideoError:" + errorCode.getDesc());
                final JSONObject jobj = new JSONObject();
                try{
                     RewardAdVO vo = getRewardVO(rewardIDcount);
                    if (vo!=null){
            ...
            public void onInterstitialAdClose(ATAdInfo entity) {
                Log.d(TAG,"onInterstitialAdClose  "+entity.toString());
...
//            }
            ...
            public void onInterstitialAdClicked(ATAdInfo entity) {
                Log.d(TAG,"onInterstitialAdClicked  "+entity.toString());
                // 广告点击，
                final JSONObject jobj = new JSONObject();
                try{
                     RewardAdVO vo = getRewardVO(rewardIDcount);
    ...
    private class RewardAdVO{
        ATInterstitial rewardedAd = null;
        int state = 0;
        String rewardID = "";
        // 是否已发送奖励
