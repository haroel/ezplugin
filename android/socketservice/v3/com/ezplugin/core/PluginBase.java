...
public abstract class PluginBase {
   ...
   * 调用此方法将事件传给JS层
   * */
  final protected void nativeEventHandler( String evt , String params){
   ...
   * */
  final protected void nativeCallbackHandler(final int callbackId,final String params){
    PluginCore.getInstance().nativeCallbackHandler(callbackId,params);
  }
  /*
   * 调用此方法将错误通过callback函数形式传给JS层，只会一次有效。注意与$eventToJS区别！
   * */
  final protected void nativeCallbackErrorHandler(final int callbackId,final String params){
